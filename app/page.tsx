      ...
      <div className="max-w-5xl mx-auto px-4 py-16">
        ...
        <header className="text-center py-20 md:py-32 mb-20">
          ...
          >
            ...
            <span className="font-semibold text-foreground">Read the Docs</span>
          </Link>
        </header>
...
function FeatureCard({
  ...
  return (
    <div className="p-6 rounded-lg border border-border hover:border-foreground/40 bg-card/30 transition-colors duration-200">
