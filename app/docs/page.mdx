...
**How to use:**
1. Install: `npm install @mrfinch/booking`
2. Configure `convex.config.ts` to use the component
3. Create `convex/booking.ts` with API exports
4. Use the `<Booker />` component in your app
